...
def test_category_novels():
    ...
    button1 = browser.find_element(By.XPATH, "//*[text()='Novels']")
    ...
    assert "Novels" in title.text, "Переход не выполнен, либо заголовок не найден"
    time.sleep(2)

    browser.quit()

#test_category_novels()
