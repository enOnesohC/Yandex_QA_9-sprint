...
def test_category_imitations():
    ...
    button1 = browser.find_element(By.XPATH, "//*[text()='Imitations']")
    ...
    assert "Imitations" in title.text, "Переход не выполнен, либо заголовок не найден"
    time.sleep(2)

    browser.quit()

test_category_imitations()
