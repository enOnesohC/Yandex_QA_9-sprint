...
def test_category_lifestyle():
    ...
    button1 = browser.find_element(By.XPATH, "//*[text()='LifeStyle']")
    ...
    assert "LifeStyle" in title.text, "Переход не выполнен, либо заголовок не найден"
    time.sleep(3)

    browser.quit()

#test_category_lifestyle()
