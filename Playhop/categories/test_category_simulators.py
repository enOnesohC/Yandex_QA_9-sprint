...
def test_category_simulators():
    ...
    button1 = browser.find_element(By.XPATH, "//*[text()='Simulators']")
    ...
    assert "Simulators" in title.text, "Переход не выполнен, либо заголовок не найден"
    time.sleep(2)

    browser.quit()

#test_category_simulators()
