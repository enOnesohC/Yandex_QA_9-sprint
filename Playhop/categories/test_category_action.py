...
def test_category_action():
    ...
    #обновление впн не всегда помогает.
    ...
    button1 = browser.find_element(By.XPATH, "//*[text()='Action']")
    ...
    assert "Action" in title.text, "Переход не выполнен, либо заголовок не найден"
    time.sleep(2)
