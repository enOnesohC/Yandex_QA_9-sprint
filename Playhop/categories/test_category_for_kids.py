...
def test_category_for_kids():
    ...
    button1 = browser.find_element(By.XPATH, "//*[text()='For kids']")
    ...
    assert "For kids" in title.text, "Переход не выполнен, либо заголовок не найден"
    time.sleep(2)

    browser.quit()

#test_category_for_kids()
