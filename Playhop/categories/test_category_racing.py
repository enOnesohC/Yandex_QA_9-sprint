...
def test_category_racing():
    ...
    button1 = browser.find_element(By.XPATH, "//*[text()='Racing']")
    ...
    assert "Racing" in title.text, "Переход не выполнен, либо заголовок не найден"
    time.sleep(2)

    browser.quit()

#test_category_racing()
