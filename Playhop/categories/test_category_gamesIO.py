...
def test_category_gamesIO():
    ...
    button1 = browser.find_element(By.XPATH, "//*[text()='Games.io']")
    ...
    assert "Games.io" in title.text, "Переход не выполнен, либо заголовок не найден"
    time.sleep(2)

    browser.quit()

#test_category_gamesIO()
