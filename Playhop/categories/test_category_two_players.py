...
def test_category_two_players():
    ...
    button1 = browser.find_element(By.XPATH, "//*[text()='Two players']")
    ...
    assert "Two players" in title.text, "Переход не выполнен, либо заголовок не найден"
    time.sleep(3)

    browser.quit()

#test_category_two_players()
