...
def test_category_horror():
    ...
    button1 = browser.find_element(By.XPATH, "//*[text()='Horror']")
    ...
    assert "Horror" in title.text, "Переход не выполнен, либо заголовок не найден"
    time.sleep(2)

    browser.quit()

#test_category_horror()
