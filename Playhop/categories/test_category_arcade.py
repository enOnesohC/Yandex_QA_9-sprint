...
def test_category_arcade():
    ...
    button1 = browser.find_element(By.XPATH, "//*[text()='Arcade']")
    ...
    assert "Arcade" in title.text, "Переход не выполнен, либо заголовок не найден"
    time.sleep(2)

    browser.quit()

#test_category_arcade()
