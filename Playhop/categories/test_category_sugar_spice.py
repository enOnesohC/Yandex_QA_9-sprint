...
def test_category_sugarspice():
    ...
    button1 = browser.find_element(By.XPATH, "//*[text()='Sugar and spice']")
    ...
    assert "Sugar and spice" in title.text, "Переход не выполнен, либо заголовок не найден"
    time.sleep(2)

    browser.quit()

#test_category_sugarspice()
