...
def test_category_casual():
    ...
    button1 = browser.find_element(By.XPATH, "//*[text()='Casual']")
    ...
    assert "Casual" in title.text, "Переход не выполнен, либо заголовок не найден"
    time.sleep(2)

    browser.quit()

#test_category_casual()
