...
def test_category_NervesOfSteel():
    ...
    button1 = browser.find_element(By.XPATH, "//*[text()='Nerves Of Steel]")
    ...
    assert "Nerves of steel" in title.text, "Переход не выполнен, либо заголовок не найден"
    time.sleep(2)

    browser.quit()

#test_category_NervesOfSteel()
