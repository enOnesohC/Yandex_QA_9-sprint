...
def test_category_economy():
    ...
    button1 = browser.find_element(By.XPATH, "//*[text()='Economy']")
    ...
    assert "Economy" in title.text, "Переход не выполнен, либо заголовок не найден"
    time.sleep(2)

    browser.quit()

#test_category_economy()
