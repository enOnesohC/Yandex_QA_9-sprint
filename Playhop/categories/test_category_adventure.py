...
def test_category_adventure():
    ...
    button1 = browser.find_element(By.XPATH, "//*[text()='Adventure']")
    ...
    assert "Adventure" in title.text, "Переход не выполнен, либо заголовок не найден"
    time.sleep(3)

    browser.quit()

#test_category_adventure()
