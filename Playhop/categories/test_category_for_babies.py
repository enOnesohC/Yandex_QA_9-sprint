...
def test_category_for_babies():
    ...
    button1 = browser.find_element(By.XPATH, "//*[text()='For babies']")
    ...
    assert "For babies" in title.text, "Переход не выполнен, либо заголовок не найден"
    time.sleep(2)

    browser.quit()

#test_category_for_babies()
