...
def test_category_midcore():
    ...
    button1 = browser.find_element(By.XPATH, "//*[text()='Midcore']")
    ...
    assert "Midcore" in title.text, "Переход не выполнен, либо заголовок не найден"
    time.sleep(2)

    browser.quit()

#test_category_midcore()
