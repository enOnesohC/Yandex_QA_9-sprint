...
def test_category_puzzles():
    ...
    button1 = browser.find_element(By.XPATH, "//*[text()='Puzzles']")
    ...
    assert "Puzzles" in title.text, "Переход не выполнен, либо заголовок не найден"
    time.sleep(2)

    browser.quit()

#test_category_puzzles()
