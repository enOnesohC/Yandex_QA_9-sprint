...
def test_tags_addictive():
    ...
    button1 = browser.find_element(By.XPATH, "//*[text()='addictive']")
    ...
    assert "addictive" in title.text, "Переход не выполнен, либо заголовок не найден"
    time.sleep(2)
