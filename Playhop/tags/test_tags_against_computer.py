...
def test_tags_againstcomputer():
    ...
    button1 = browser.find_element(By.XPATH, "//*[text()='against computer']")
    ...
    assert "against computer" in title.text, "Переход не выполнен, либо заголовок не найден"
    time.sleep(2)

    browser.quit()

#test_tags_againstcomputer()
