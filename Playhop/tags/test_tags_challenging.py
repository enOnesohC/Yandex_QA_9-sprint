...
def test_tags_challenging():
    ...
    button1 = browser.find_element(By.XPATH, "//*[text()='challenging']")
    ...
    assert "challenging" in title.text, "Переход не выполнен, либо заголовок не найден"
    time.sleep(2)

    browser.quit()

#test_tags_challenging()
