...
def test_tags_braintraining():
    ...
    button1 = browser.find_element(By.XPATH, "//*[text()='brain training']")
    ...
    assert "brain training" in title.text, "Переход не выполнен, либо заголовок не найден"
    time.sleep(2)

    browser.quit()

#test_tags_braintraining()
