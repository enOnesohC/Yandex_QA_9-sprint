...
def test_tags_fullscreen():
    ...
    button1 = browser.find_element(By.XPATH, "//*[text()='fullscreen']")
    ...
    assert "fullscreen" in title.text, "Переход не выполнен, либо заголовок не найден"
    time.sleep(2)

    browser.quit()

#test_tags_fullscreen()
