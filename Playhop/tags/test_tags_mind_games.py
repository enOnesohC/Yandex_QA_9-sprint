...
def test_tags_mindgames():
    ...
    button1 = browser.find_element(By.XPATH, "//*[text()='mind games']")
    ...
    assert "mind games" in title.text, "Переход не выполнен, либо заголовок не найден"
    time.sleep(2)
