...
def test_tags_highquality():
    ...
    button1 = browser.find_element(By.XPATH, "//*[text()='high quality']")
    ...
    assert "high quality" in title.text, "Переход не выполнен, либо заголовок не найден"
    time.sleep(2)

    browser.quit()

#test_tags_highquality()
