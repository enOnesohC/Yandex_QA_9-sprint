...
def test_tags_attention():
    ...
    button1 = browser.find_element(By.XPATH, "//*[text()='attention']")
    ...
    assert "attention" in title.text, "Переход не выполнен, либо заголовок не найден"
    time.sleep(2)
